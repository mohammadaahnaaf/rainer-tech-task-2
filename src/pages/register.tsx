...
const Register = (props: Props) => {
    ...
    return (
        <div className="grid grid-cols-3 h-[100vh] w-full">
            <div className='col-span-3 lg:col-span-2 xl:col-span-1 h-full w-full content-center text-black bg-sky-600 bg-opacity-10 backdrop-blur-sm p-3 md:p-6'>
                <form onSubmit={handleSubmit} className='grid gap-4 h-full content-center'>
                    ...
                    <h1 className='text-center text-2xl md:text-3xl pb-4 font-semibold'>Register Here</h1>
...
export default function RegisterPage() {
    return (
        <>
            <Head>
                <title>RainTech | Register</title>
            </Head>
            <div className='bg-[url("/bg2.jpg")] object-cover bg-cover'>
                <section>
                    <Register />
                </section>
            </div>
